...
HD_PWD='E:/VHDL_project/N_bit_divinder/N_bit_divinder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_divinder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n_bit_divinder.tcl -notrace
