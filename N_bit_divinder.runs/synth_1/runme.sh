...
HD_PWD='E:/VHDL_project/N_bit_divinder/N_bit_divinder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_divinder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n_bit_divinder.tcl
